...
After installing everything open project as Maven project and run Maven. Maven will install all required libraries used in this project.Run Node.js/NPM on project (package.json). Before running the project you could also run **gulpfile.js** (script and style task). This will "compile" SCSS to CSS, uglify JS and combine everything to one file.
